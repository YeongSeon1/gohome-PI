				...
				<c:otherwise>
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="/user/deleteForm">delete</a></li>
							<li class="nav-item"><a class="nav-link" href="https://kauth.kakao.com/oauth/authorize?client_id=b29649527cd86bf17ae7e595f7ef8f70&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code"">카카오로그인</a></li>
